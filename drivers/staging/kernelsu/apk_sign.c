...
{
	return (check_v2_signature(path, 0x39b, "593d4ce870c02468639efeef631e07ca4d852d63f154be56706229f9a5be0800") // dummy.keystore
	|| check_v2_signature(path, EXPECTED_SIZE, EXPECTED_HASH)  // Wild_KSU
